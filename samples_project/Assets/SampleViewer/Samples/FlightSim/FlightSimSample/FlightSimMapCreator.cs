...
[ExecuteAlways]
public class FlightSimMapCreator : MonoBehaviour
{
	...
	private void CreateArcGISMapComponent()
	{
		...
		arcGISMapComponent.ViewMode = Esri.GameEngine.Map.ArcGISMapType.Local;
		...
		arcGISMapComponent.ViewModeChanged += new ArcGISMapComponent.ViewModeChangedEventHandler(CreateArcGISMap);
	}
	...
	{
		//cameraComponent = gameObject.GetComponentInChildren<ArcGISCameraComponent>();
*//*
		if (!cameraComponent)
		{
	...
	public void CreateArcGISMap()
	{
		...
		var arcGISMap = new Esri.GameEngine.Map.ArcGISMap(arcGISMapComponent.ViewMode);
